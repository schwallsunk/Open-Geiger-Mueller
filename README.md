This repository should provide all the needed parts for the construction of low-cost entry level Geiger Müller (GM) counter system.
...
The microcontroller of choice here is the Rasperry Pico 2W, allowing for programming in a multitude of languages (Micropython, AVR, C++, C), lowering the overall barrier to entry into microcontroller (uC) programming. 
